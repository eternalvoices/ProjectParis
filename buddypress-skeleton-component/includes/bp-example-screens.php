...
function pp_add_event(){
	 ...
	 */
	//do_action( 'pp_add_event' );

	add_action( 'bp_template_title', 'pp_add_event_title' );
	add_action( 'bp_template_content', 'pp_add_event_content' );
	...
	function pp_add_event_title() {
		_e( 'New Event', 'bp-example' );
	}

	function pp_add_event_content() {
		global $bp;
		//$toto=date( 'Y-m-d H:i:s' );
		//echo ($toto);
		$send_link = wp_nonce_url( $bp->displayed_user->domain . $bp->current_component . '/pp-add-event/add-event', 'pp_add_event_function' );
		
		?><form action="<?php echo $send_link ?>" name="pp-event-add-form" id="pp-event-add-form" method="post">
			<table class="form-table">
				<tr valign="top">
					<th scope="row"><label for="target_uri"><?php _e( 'Event Name', 'bp-example' ) ?></label></th>
					<td>
						<input name="pp-event-add-event-name" type="text" id="pp-event-add-event-name" size="60" />
					</td>
				</tr>
					<th scope="row"><label for="target_uri"><?php _e( 'Event Desription', 'bp-example' ) ?></label></th>
					<td>
						<input name="pp-event-add-event-description" type="text" id="pp-event-add-event-description" size="60" />
					</td>
				</tr>
				</tr>
					<th scope="row"><label for="target_uri"><?php _e( 'Event Place ID', 'bp-example' ) ?></label></th>
					<td>
						<input name="pp-event-add-place-id" type="text" id="pp-event-add-place-id" size="60" />
					</td>
				</tr>
				</tr>
					<th scope="row"><label for="target_uri"><?php _e( 'Event Type', 'bp-example' ) ?></label></th>
					<td>
						<input name="pp-event-add-event-type" type="text" id="pp-event-add-event-type" size="60" />
					</td>
				</tr>
				</tr>
					<th scope="row"><label for="target_uri"><?php _e( 'Event Time', 'bp-example' ) ?></label></th>
					<td>
						<input name="pp-event-add-event-time" type="text" id="pp-event-add-event-time" size="60" />
					</td>
				</tr>
				</tr>
					<th scope="row"><label for="target_uri"><?php _e( 'Invite', 'bp-example' ) ?></label></th>
					<td>
						<input name="pp-event-add-invitee-list" type="text" id="pp-event-add-invitee-list" size="60" />
					</td>
				</tr>
			</table>
			<p class="submit">
				<input type="submit" name="submit" value="<?php _e( 'Save Event', 'bp-example' ) ?>"/>
			</p>
